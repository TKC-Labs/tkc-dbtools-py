CREATE USER IF NOT EXISTS 'usermgr'@'192.168.123.16' IDENTIFIED BY 'Super-Secure-Password';
CREATE USER IF NOT EXISTS 'usermgr'@'192.168.123.17' IDENTIFIED BY 'Super-Secure-Password';
CREATE USER IF NOT EXISTS 'usermgr'@'192.168.123.18' IDENTIFIED BY 'Super-Secure-Password';
